...
var load = (options, fullPath) => new Promise(res => {
  ...
  (register === null || register === void 0 ? void 0 : register.length) && register.forEach(r => {
        ...
        if (validateRoute("".concat(fullPath).concat(file))) {
          ...
          if (routes !== null && routes !== void 0 && routes.length) {
            ...
            routes.forEach((_ref3) => {
              ...
              debug && console.log("".concat(method.toUpperCase(), " ").concat(treePath + path)); // Load with plugin
              ...
              if (plugin) {
                ...
                app[pluginValues.method.toLowerCase()](treePath + pluginValues.path || path, before || ((_pluginValues = pluginValues) === null || _pluginValues === void 0 ? void 0 : _pluginValues.before) || defaultAction, action || ((_pluginValues2 = pluginValues) === null || _pluginValues2 === void 0 ? void 0 : _pluginValues2.action) || defaultAction);
              } else {
                app[method.toLowerCase()](treePath + path, before || defaultAction, action || defaultAction);
              }
            });
          }
        }
